test_that("Negative zeroes are being tracked properly", {
  ...
  ## --> linear
  expect_true(has_negative_zero((-1) * natural0()))
  expect_false(has_positive_zero((-1) * natural0()))
  expect_false(has_negative_zero((-1) * natural0() + 1))
  expect_true(has_positive_zero((-1) * natural0() + 1))
  expect_false(has_negative_zero(-natural0()))
  expect_true(has_positive_zero(-natural0()))
  expect_false(has_negative_zero(-1L * natural0()))
  expect_true(has_positive_zero(-1L * natural0()))
