test_that("Ops with length-0 vectors", {
  # Numeric vs Integer
  expect_identical(integers() * integer(), empty_series("integer"))
  expect_identical(integers() + integer(), empty_series("integer"))
  expect_identical(integers() * numeric(), empty_series("double"))
  expect_identical(integers() + numeric(), empty_series("double"))
  expect_identical(integers() ^ integer(), empty_series("double"))
  expect_identical(integer() ^ integers(), empty_series("double"))
  expect_identical(integers() ^ numeric(), empty_series("double"))
  expect_identical(numeric() ^ integers(), empty_series("double"))
  # Length-0 series
  expect_identical(empty_series() * 2, empty_series())
  expect_identical(empty_series() + 2, empty_series())
  expect_identical(empty_series() ^ 2, empty_series())
  expect_identical(2 ^ empty_series(), empty_series())
  expect_identical(empty_series("integer") * 2L, empty_series("integer"))
  expect_identical(empty_series("integer") + 2L, empty_series("integer"))
})
